...
if __name__ == '__main__':
    ...
    @fgk_autotune(
        configs=[
            triton.Config( {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 256, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=2, num_warps=8),
            triton.Config( {"BLOCK_M_SIZE": 256, "BLOCK_N_SIZE": 128, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=2, num_warps=8),
            triton.Config( {"BLOCK_M_SIZE": 256, "BLOCK_N_SIZE": 64, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=2, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 256, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=2, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 128, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=2, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 64, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=3, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 128, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=3, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 32, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=3, num_warps=4),
            triton.Config( {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 32, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=5, num_warps=2),
            triton.Config( {"BLOCK_M_SIZE": 32, "BLOCK_N_SIZE": 64, "BLOCK_K_SIZE": 32, "GROUP_M_SIZE": 8}, num_stages=5, num_warps=2),
        ],
        key=['m_size'],
        ret_ptr=2,
